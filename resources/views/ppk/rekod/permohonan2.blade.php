                ...
                <td>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('semasa1Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Semasa 1', 'id' => 'semasa1Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('semasa2Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Semasa 2', 'id' => 'semasa2Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('semasa3Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Semasa 3', 'id' => 'semasa3Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('semasa4Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Semasa 4', 'id' => 'semasa4Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('semasa5Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Semasa 5', 'id' => 'semasa5Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('biasa1Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Biasa 1', 'id' => 'biasa1Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('biasa2Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Biasa 2', 'id' => 'biasa2Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('biasa3Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Biasa 3', 'id' => 'biasa3Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('tetap1Select', $banks, '', ['class' => 'form-control', 'step' => 'any', 'placeholder' => 'Akaun Tetap 1', 'id' => 'tetap1Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('tetap2Select', $banks, '', ['class' => 'form-control', 'step' => 'any', 'placeholder' => 'Akaun Tetap 2', 'id' => 'tetap2Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('tetap3Select', $banks, '', ['class' => 'form-control', 'placeholder' => 'Akaun Tetap 3', 'id' => 'tetap3Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('tetap4Select', $banks, '', ['class' => 'form-control', 'step' => 'any', 'placeholder' => 'Akaun Tetap 4', 'id' => 'tetap4Select']) }}                                
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::select('tetap5Select', $banks, '', ['class' => 'form-control', 'step' => 'any', 'placeholder' => 'Akaun Tetap 5', 'id' => 'tetap5Select']) }}                                
