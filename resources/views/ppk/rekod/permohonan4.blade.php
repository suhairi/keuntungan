                ...
                <td>
                    ...
                    <table width="100%" border=0>
                        ...
                        <tr>
                            ...
                            <td width="35">RM</td>
                            <td>{{ Form::number('aItem2', session('aItem2'), ['class' => 'form-control', 'id' => 'aItem2', 'required', 'readonly', 'placeholder' => '0.00', 'value' => session('aItem2')])}}</td>
                        </tr>
                        <tr>
                            <td colspan="2" width=400>Siberhutang Perniagaan - Bukan Ahli</td>
                            <td width="35">RM</td>
                            <td>{{ Form::number('aItem3', session('aItem3'), ['class' => 'form-control', 'id' => 'aItem3', 'required', 'readonly', 'placeholder' => '0.00'])}}</td>
                        </tr>
                        <tr>
                            <td colspan="2" width=400>Pinjaman Tanpa Cagaran</td>
                            <td width="35">RM</td>
                            <td>{{ Form::number('aItem4', session('aItem4'), ['class' => 'form-control', 'id' => 'aItem4', 'required', 'readonly', 'placeholder' => '0.00'])}}</td>
                        </tr>
                        <tr>
                            <td colspan="2" width=400>Siberhutang-siberhutang Lain</td>
                            <td width="35">RM</td>
                            <td>{{ Form::number('aItem5', session('aItem5'), ['class' => 'form-control', 'id' => 'aItem5', 'required', 'readonly', 'placeholder' => '0.00'])}}</td>
                        </tr>
                    ...
                    <table width="100%" border=0>
                        <tr>
                            <td colspan="2"></td>
                            <td width="35">RM</td>
                            <td width="250">{{ Form::number('bUntungBersih', session('bUntungBersih'), ['class' => 'form-control', 'readonly', 'id' => 'bUntungBersih', 'required', 'placeholder' => '0.00'])}}</td>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
                </td>
