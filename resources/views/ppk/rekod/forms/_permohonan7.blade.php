				...
				<!-- ##################### -->
					...
					<table width="100%" style="border: 1px solid #333333">
						...
						<tr>
							...
							<td style="border-left: 1px solid #333333">&nbsp;</td>	
							<td align="right" style="border-left: 1px solid #333333">{{ Form::number('luarbiasa', '0.00', ['class' => 'form-control', 'id' => 'luarbiasa', 'readonly']) }}</td>
							<!-- <td style="border-left: 1px solid #333333">&nbsp;</td>
							<td style="border-left: 1px solid #333333">&nbsp;</td> -->
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border-left: 1px solid #333333">&nbsp;</td>	
							<td align="right" style="border-left: 1px solid #333333">{{ Form::number('yayasan', '0.00', ['class' => 'form-control', 'id' => 'yayasan', 'readonly']) }}</td>
							<!-- <td style="border-left: 1px solid #333333">&nbsp;</td>
							<td style="border-left: 1px solid #333333">&nbsp;</td> -->
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border-left: 1px solid #333333">&nbsp;</td>	
							<td align="right" style="border-left: 1px solid #333333">{{ Form::number('pelarasan', '0.00', ['class' => 'form-control', 'placeholder' => 'RM 0.00', 'id' => 'pelarasan', 'readonly']) }}</td>
							<!-- <td style="border-left: 1px solid #333333">&nbsp;</td>
							<td style="border-left: 1px solid #333333">&nbsp;</td> -->
						</tr>
						...
						<tr>
							...
							<td style="border-left: 1px solid #333333">&nbsp;</td>
							<td style="border-left: 1px solid #333333">{{ Form::number('jumlah', '', ['class' => 'form-control', 'placeholder' => 'RM 0.00', 'readonly', 'id' => 'jumlah']) }}</td>
							<!-- <td style="border-left: 1px solid #333333">&nbsp;</td>
							<td style="border-left: 1px solid #333333">&nbsp;</td> -->
						</tr>
						<tr>
